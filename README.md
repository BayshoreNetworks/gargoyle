...
Required libs
	...
	Debian variant:
		...
		sudo apt-get install sqlite3 libsqlite3-dev autoconf lsb-base libnetfilter-log-dev libpcap-dev libpcre++-dev g++ make

	Fedora:

		sudo dnf install sqlite3 libsqlite3x-devel autoconf redhat-lsb-core libnetfilter_log-devel libpcap-dev pcre-devel gcc-c++ make
